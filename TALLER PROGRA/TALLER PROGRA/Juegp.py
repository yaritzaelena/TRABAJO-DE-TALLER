...
listaEnemigo = []
venta = pygame.display.set_mode((950,480)) # Creacion de la ventana 
...
class Juegos(pygame.sprite.Sprite):
    ...
    def __init__ (self):
        ...
        self.ImgagenExplosion = pygame.image.load('explosion1.png')
...
def main():
    ...
    Texto = miFuenteSistema.render('Fin del juego',0,(248,248,255))
