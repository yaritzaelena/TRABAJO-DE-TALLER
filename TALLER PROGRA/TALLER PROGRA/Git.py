...
def main():
    ...
    ImagenFondo = pygame.image.load('Imagenes/fondo.jpg') # Imagen de fondo para la ventana
    ...
    while True:
        ...
        if len (jugador.listaDisparo)>0: #Cuando el jugador dispara
                        ...
                        if len (enemigo.listaDisparo)>0:
                            for x in enemigo.listaDisparo:
                                ...
                                if x.rect.colliderect(jugador.rect):
                                    risa =  pygame.mixer.Sound ('Sonido/risa.wav')
                                    risa.play()
                                    jugador.destruccion()
                                    enJuego=False
                                    detenerJuego()
